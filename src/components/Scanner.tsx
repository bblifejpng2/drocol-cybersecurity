...
const Scanner: React.FC<ScannerProps> = ({
  ...
  useEffect(() => {
    ...
    (u.uColor1.value as Float32Array).set([r1, g1, b1]);
    (u.uColor2.value as Float32Array).set([r2, g2, b2]);
    (u.uColor3.value as Float32Array).set([r3, g3, b3]);
