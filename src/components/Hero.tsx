...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative flex min-h-[45vh] sm:min-h-[50vh] items-center overflow-hidden bg-[#FFFFFF]">
      {/* Interactive globe — absolute, centered BEHIND the content */}
      <div className="absolute inset-0 flex items-center justify-center">
        <InteractiveGlobe className="w-[min(320px,55vw,35vh)]" />
      </div>

      {/* Content — layered above the globe */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8 md:px-10 py-6 sm:py-8 md:py-10">
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 mb-3 sm:mb-4 px-4 py-2 rounded-full border border-neutral-900/10 bg-neutral-900/[0.04]"
          >
          ...
          <h1 className="text-[38px] xs:text-[44px] sm:text-6xl md:text-[64px] lg:text-[76px] xl:text-[82px] font-bold leading-[1.05] tracking-[-0.03em] mb-3 sm:mb-4 text-neutral-900 font-sans max-w-4xl">
          ...
          <p className="text-[16px] sm:text-[17px] lg:text-[19px] text-neutral-600 max-w-xl font-inter leading-relaxed mx-auto mb-4 sm:mb-6">
          ...
          {/* CTAs */}
          <div className="flex flex-wrap justify-center gap-3 mb-3 sm:mb-5">
            <SpecularButton
              {...specularPrimary}
              size="lg"
              href="/contact"
